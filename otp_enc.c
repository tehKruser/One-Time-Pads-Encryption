...
int main(int argc, char *argv[])
{
    ...
    // sendString will consist of who$encryptString#keyString@
    char* whoString = "otp_enc$";
    ...
    setStringFromFile(argv[1], encryptString, "#");
    setStringFromFile(argv[2], keyString, "@");

    int encStrLen = strlen(encryptString);
    ...
    validateInput(encryptString);

    strcpy(sendString, whoString);
    strcat(sendString, encryptString);
